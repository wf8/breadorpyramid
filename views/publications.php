			<div class="row-fluid nice_margins">
      		...
      		<div class="row-fluid nice_margins">
      			<div class="span12">
					...
					<h4>Articles</h4>
					<p>Olfelt, J.P. and W.A. Freyman. In prep. Relationships of the North American <em>Rhodiola</em> (Crassulaceae).</p>
					<p>Freyman, W.A. and K.A. Glennemeier. Accepted. Restoration Map: a web-based tool for spatial and participatory adaptive management of ecological restoration projects. Ecological Restoration.</p>
				</div>
      		</div>
      		<hr>
